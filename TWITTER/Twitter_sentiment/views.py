...
def trend(request):
    API_key = "Gji5bi3VSntlCgBgWysUD7vXI"
    API_secret_key = "rDpNory7cCfuRkwqUQTdMKBKPh0KNsKHhlS8vfZ4mSbGWSyp1e"
...
def search(request):
    ...
    tweets = tweepy.Cursor(api.search_tweets, q=searchTerm, lang="en", tweet_mode='extended').items(NoOfTerms)
